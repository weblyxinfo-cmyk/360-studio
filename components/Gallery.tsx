...
const fallbackItems = [
  ...
  { id: "5", tag: "Neon", title: "Neon party s mazlíkem", subtitle: "Zábava pro všechny včetně čtyřnohých kamarádů", hasPlay: false, imageUrl: "/images/gallery/neon-party.jpg", gridSpan: "1x1" },
