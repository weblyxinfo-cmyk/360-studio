        ...
        <div className="contact-info">
          ...
          <div className="contact-block">
            ...
            <div className="social-links">
              ...
              <a href="https://www.tiktok.com/@kajo.studio.360" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="TikTok" style={{ color: "#fff" }}><IconTikTok /></a>
            </div>
          </div>
